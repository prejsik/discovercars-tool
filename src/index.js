...
Flags:
  ...
  --pick-durations      Interactive picker for durations (supports values 1..20).
  ...
  --durations=A,B       Rental duration days list (default: 1..10, supports 1..20). Example: --durations=1,2,3
...
async function chooseDurationsInteractively(currentDurations) {
  ...
  console.log("Wybierz durations (dni najmu) z zakresu 1-20.");
